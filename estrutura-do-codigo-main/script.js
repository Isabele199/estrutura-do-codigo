...
const perguntas = [
    {
        enunciado: "É impossivel diminuir a desigualdade econômica causada pela falta de desemprego?",
        alternativas: [
            {
                texto: "Uma possível solução seria o investimento para apoiar as micro empresas que são as que mais sofrem, por falta de incentivo nas crises.w",
            ...
            {
                texto: "Uma excelente alternativa é a ação de inclusão social Fortalecimento de políticas de acesso à saúde, moradia, saneamento básico e outros serviços públicos essenciais.",
